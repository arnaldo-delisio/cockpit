...
| `memory-engine/DESIGN.md` §8 | Full ingestion section: capture layer, three modes, dream mechanics, model routing detail |
| `memory-engine/DESIGN.md` §10 | Self-improvement + GC: character-cap backstop, supersede vs delete, OPEN-2 |
