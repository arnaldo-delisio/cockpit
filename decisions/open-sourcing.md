...
|---|---|---|
| **What** | engine code (`memory/engine/`), `memory/DESIGN.md`, `DECISIONS.md`, `decisions/`, `skills/`, `bootstrap.mjs`, the shell skeletons | `memory/scopes/` (identity, logs, staging, sources), `memory/knowledge/` (nodes, INDEX) |
