...
- **Asktool means stop for the decision.** When Arnaldo says “asktool,” use the clarification tool to surface the choice and wait for his answer. If the ask times out, do not treat timeout as consent to proceed on strategic/product/architecture/grey-area decisions; report that no choice came back and pause unless the next action is genuinely obvious and low-stakes.
